...
class ComposeImageRTTTestViewSet(ChangeSetModelMixin,
                                 StrictQueryParamMixin,
                                 MultiLookupFieldMixin,
                                 viewsets.GenericViewSet):
    """
    ...
    def create(self, request, *args, **kwargs):
        ...
        """
        return super(ComposeImageRTTTestViewSet, self).create(request, *args, **kwargs)
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        """
        return super(ComposeImageRTTTestViewSet, self).destroy(request, *args, **kwargs)
